...
# cs111-F2017-practical1

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the startere for practical 1 in Computer Science 111.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-111-F2017/cs111-F2017-practical1-starter.git
```
